...
APPEND ${TEMP_TABLE_NAME}(CIF, CID, HR_TITLE, HR_NAME, HR_SURNAME, STU_BIRTHDATE, BIRTH_DAY, BIRTH_MONTH, BIRTH_YEAR, STU_SEX, STU_STATUS, STATUS_USER, STATUS_DATE, STU_EMAIL, BOX_NO, BATCH_NO, SEQ_NO, STUDT_CODE, STUDT_CODE2, STUDT_CODE3, STU_UNIV_ID, HA_HOME_NO, HA_NO, HA_BUILDING, HA_FLOOR, HA_ROOMNO, HA_VILLAGE, HA_MOO, HA_TRONG, HA_SOI, HA_ROAD, HA_TAMNAME, HA_AMPNAME, HA_PROVNAME, HA_MOICODE, HA_POSTAL_CODE, HA_TEL_NO, HA_FAX_NO, STUDENT_STATUS, GUARANTOR_STATUS, AGENTOR_STATUS, ISALAM_STATUS, UPD_USER, UPD_DATE, CREATE_BY, CREATE_DATE, PROVINCE_CODE, BOX_SEND_NO, BOX_SEND_DOC, BOX_REC_DOC, MOI_STATUS, MOI_STATUS_UPD_USER, MOI_STATUS_UPD_DATE) USING -
